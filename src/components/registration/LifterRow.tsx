          ...
          <Container style={gridStyle}>
            ...
            <Row>
              <Col md={6}>
                <Form.Group>
                  <Form.Label>
                    Athlete Photo <small className="text-muted">(optional)</small>
                  </Form.Label>
                  {entry.athletePhotoUrl && (
                    <div style={{ marginBottom: "6px" }}>
                      <img
                        src={entry.athletePhotoUrl}
                        alt="athlete"
                        style={{
                          width: "60px",
                          height: "60px",
                  ...
                  <Form.Control
                    ...
                    onChange={(e: React.BaseSyntheticEvent) => {
                      ...
                      reader.onload = (ev) => {
                        this.props.updateRegistration(this.props.id, { athletePhotoUrl: ev.target?.result as string });
                      };
              ...
              <Col md={6}>
                <Form.Group>
                  <Form.Label>
                    Club Logo <small className="text-muted">(optional)</small>
                  </Form.Label>
                  {entry.clubLogoUrl && (
                    <div style={{ marginBottom: "6px" }}>
                      <img
                  ...
                  <Form.Control
                    ...
                    onChange={(e: React.BaseSyntheticEvent) => {
                      ...
                      const reader = new FileReader();
                      reader.onload = (ev) => {
                        this.props.updateRegistration(this.props.id, { clubLogoUrl: ev.target?.result as string });
                      };
                      reader.readAsDataURL(file);
                    }}
                  />
