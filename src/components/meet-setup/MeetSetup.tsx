...
interface DispatchProps {
  ...
  setCompetitionMode: (mode: "Standard" | "Handicap") => void;
}
          ...
          <Col md={4}>
            <Card>
              ...
              <Card.Body>
                ...
                <FormGroup>
                  <Form.Label style={{ fontWeight: 600 }}>Competition Mode</Form.Label>
                  <FormControl
                    as="select"
                    value={this.props.meet.competitionMode || "Standard"}
                    onChange={(e: React.BaseSyntheticEvent) =>
                      this.props.setCompetitionMode(e.target.value as "Standard" | "Handicap")
                    }
                    className="custom-select"
                  >
                    <option value="Standard">Standard (Squat / Bench / Deadlift)</option>
                    <option value="Handicap">Handicap — Bench Only</option>
                  </FormControl>
                  {this.props.meet.competitionMode === "Handicap" && (
                    <div
                      style={{
                        marginTop: "8px",
                        padding: "6px 12px",
                    ...
                    >
                      <strong>Handicap mode:</strong> Squat and Deadlift columns are hidden.
                    </div>
                  )}
                </FormGroup>
              </Card.Body>
...
const mapDispatchToProps = (dispatch: Dispatch): DispatchProps => ({
  ...
  setCompetitionMode: (mode: "Standard" | "Handicap") => {
    dispatch(updateMeet({ competitionMode: mode }));
  },
});
