...
class LiftingTable extends React.Component<Props> {
  ...
  render() {
    ...
    const isHandicap = this.props.meet.competitionMode === "Handicap";

    if (!isHandicap && this.props.lifting.lift === "S") {
      ...
      columns.push("B1", "D1");
    } else if (this.props.lifting.lift === "B" || isHandicap) {
      if (!isHandicap) columns.push("BestSquat", "Spacer1");
      else columns.push("Spacer1");
      columns.push("B1", "B2", "B3");
      if (this.props.attemptOneIndexed === 4) {
        columns.push("B4");
      }
      if (!isHandicap) columns.push("Spacer2", "D1");
      else columns.push("Spacer2");
    } else if (!isHandicap && this.props.lifting.lift === "D") {
